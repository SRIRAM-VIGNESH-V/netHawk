...
def print_figlet(sleep=True):
    ...
    f'''
            | |             | |  | |              | |   
   ___ _   _| |__   ___ _ __| |__| | __ ___      _| | __
  / __| | | | '_ \ / _ \ '__|  __  |/ _` \ \ /\ / / |/ /
 | (__| |_| | |_) |  __/ |  | |  | | (_| |\ V  V /|   < 
  \___|\__, |_.__/ \___|_|  |_|  |_|\__,_| \_/\_/ |_|\_\
        __/ |                                           
       |___/    
...
def arguments():
    parser = argparse.ArgumentParser(description="netHawk - Network Tool",usage="\n\tnetHawk.py -sC 192.168.0.106\n\tnetHawk.py -sA 192.168.0.106")
